...
class BookCreateTest extends TestCase
{
    ...
    {
        $response = $this->login()->get('/books/create');
        $response->assertOk();
    }

    /** @test */
    public function viewにコピー元の書籍データを渡すこと(): void
    {
    ...
    /** @test */
    public function コピー元が見つからない場合は404エラーを返すこと(): void
    {
        $response = $this->login()->get('/books/create?from=invalid');
