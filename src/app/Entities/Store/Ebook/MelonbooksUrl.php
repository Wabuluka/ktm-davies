...
final class MelonbooksUrl extends PurchaseUrlBase implements CanGenerateUrlFromBookTitle
{
    ...
    {
        if ($this->makerId) {
            return new Url("https://www.melonbooks.co.jp/maker/index.php?maker_id={$this->makerId}&pageno=1&search_target[]=2&name={$title}");
        } else {
            return new Url("https://www.melonbooks.co.jp/search/search.php?search_target[]=2&name={$title}");
        }
    }
}
